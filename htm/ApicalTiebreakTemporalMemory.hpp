...
#include "ApicalTiebreakTemporalMemoryProto.capnp.h"
...
namespace nupic {
  namespace experimental {
    namespace apical_tiebreak_temporal_memory {
      ...
      // helper for printing out vectors
      template <typename T>
	...
	return os;
      ...
      public:
         ...
         *
	 * Changed to always be organized by row, column matrix indexing
	 * @param regionWidth
	 * @param regionHeight
         * regionWidth x regionHeight yealds the total number of minicolumns

         * columnCount computed number of minicolumns
         *
	...
	void initialize(
	  ...
	  bool checkInputs);
        ...
        */
        ...
        std::vector<CellIdx> getLearningCells() const;	
	...
	UInt16 regionHeight_;
        ...
        std::vector<CellIdx> learningCells_;	
