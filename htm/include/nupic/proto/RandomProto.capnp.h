...
#ifndef CAPNP_INCLUDED_88eaee6db8e1f67c_
#define CAPNP_INCLUDED_88eaee6db8e1f67c_
...
public:
  ...
  inline  ::capnp::List< ::int64_t>::Reader getState() const;
...
public:
  ...
  inline  ::capnp::List< ::int64_t>::Builder getState();
  inline void setState( ::capnp::List< ::int64_t>::Reader value);
  inline void setState(::kj::ArrayPtr<const  ::int64_t> value);
  inline  ::capnp::List< ::int64_t>::Builder initState(unsigned int size);
  inline void adoptState(::capnp::Orphan< ::capnp::List< ::int64_t>>&& value);
  inline ::capnp::Orphan< ::capnp::List< ::int64_t>> disownState();
...
inline  ::capnp::List< ::int64_t>::Reader RandomImplProto::Reader::getState() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::int64_t>>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::int64_t>::Builder RandomImplProto::Builder::getState() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::int64_t>>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void RandomImplProto::Builder::setState( ::capnp::List< ::int64_t>::Reader value) {
...
inline  ::capnp::List< ::int64_t>::Builder RandomImplProto::Builder::initState(unsigned int size) {
...
inline ::capnp::Orphan< ::capnp::List< ::int64_t>> RandomImplProto::Builder::disownState() {
...
#endif  // CAPNP_INCLUDED_88eaee6db8e1f67c_
