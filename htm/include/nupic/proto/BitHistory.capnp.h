...
#ifndef CAPNP_INCLUDED_c7158cb7b34ac59a_
#define CAPNP_INCLUDED_c7158cb7b34ac59a_
...
public:
  ...
  inline  ::capnp::List< ::BitHistoryProto::Stat>::Reader getStats() const;
...
public:
  ...
  inline  ::capnp::List< ::BitHistoryProto::Stat>::Builder getStats();
  inline void setStats( ::capnp::List< ::BitHistoryProto::Stat>::Reader value);
  inline  ::capnp::List< ::BitHistoryProto::Stat>::Builder initStats(unsigned int size);
  inline void adoptStats(::capnp::Orphan< ::capnp::List< ::BitHistoryProto::Stat>>&& value);
  inline ::capnp::Orphan< ::capnp::List< ::BitHistoryProto::Stat>> disownStats();
...
inline  ::capnp::List< ::BitHistoryProto::Stat>::Reader BitHistoryProto::Reader::getStats() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::BitHistoryProto::Stat>>::get(_reader.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::BitHistoryProto::Stat>::Builder BitHistoryProto::Builder::getStats() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::BitHistoryProto::Stat>>::get(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline void BitHistoryProto::Builder::setStats( ::capnp::List< ::BitHistoryProto::Stat>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::BitHistoryProto::Stat>>::set(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List< ::BitHistoryProto::Stat>::Builder BitHistoryProto::Builder::initStats(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::BitHistoryProto::Stat>>::init(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), size);
}
inline void BitHistoryProto::Builder::adoptStats(
    ::capnp::Orphan< ::capnp::List< ::BitHistoryProto::Stat>>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::BitHistoryProto::Stat>>::adopt(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::List< ::BitHistoryProto::Stat>> BitHistoryProto::Builder::disownStats() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::BitHistoryProto::Stat>>::disown(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
...
#endif  // CAPNP_INCLUDED_c7158cb7b34ac59a_
