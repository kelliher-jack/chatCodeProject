...
#ifndef CAPNP_INCLUDED_e7a17ea776969175_
#define CAPNP_INCLUDED_e7a17ea776969175_
...
inline  ::capnp::List< ::uint32_t>::Reader SegmentUpdateProto::Reader::getSynapses() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::uint32_t>>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::uint32_t>::Builder SegmentUpdateProto::Builder::getSynapses() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::uint32_t>>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void SegmentUpdateProto::Builder::setSynapses( ::capnp::List< ::uint32_t>::Reader value) {
...
inline  ::capnp::List< ::uint32_t>::Builder SegmentUpdateProto::Builder::initSynapses(unsigned int size) {
...
inline ::capnp::Orphan< ::capnp::List< ::uint32_t>> SegmentUpdateProto::Builder::disownSynapses() {
...
#endif  // CAPNP_INCLUDED_e7a17ea776969175_
